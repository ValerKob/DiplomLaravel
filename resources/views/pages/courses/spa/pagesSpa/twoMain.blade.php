            ...
            <div class="row mt-5">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p>
                            В папке проекта содать папку, Pages и в ней два файла Test.jsx и Glav.jsx - страницы сайта.аа
                        <p>
                    </div>
                </div>
            </div>
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        <p>
                            ...
                            <'Test />'", так же важно не забывать, "Состояния можно изменять, свойства нельзя", на рисунке показана страница, которая будет выведена в результате.
                        </p>
                        <p>
