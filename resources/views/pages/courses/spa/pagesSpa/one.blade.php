        ...
        <div class="">
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        ...
                        <p>
                            Прежде чем приступать к работе, для начала разорхивируем весь архив, далее запустим виртулаьный хостинг, у меня это Open Server.
                        <p>
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p style="text-indent: 20px; margin-top: 50px;">
                            После того как вы перетащили в папку domains, папку "api_v2-main", откройте проект с помощью вашей IDE, у меня это VSC, после открытия проекта в вашей IDE, откройте файл "README.md", в этом файле показано полная инструкция по установке проекта.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row mt-5">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        <p style="text-indent: 20px; margin-top: 50px;">
                            Далее следующим шагом, откройте проект через косноль, через терминал OpenServer, открываю папку в терминале, туда я поподаю по средством ввода комманд, "cd 'названи папки'", так же вы можете попасть туда, посредством нажатия на TAB, консоль сама будет подсказывать, а октрыть косноль можно очень просто, нажать на нижней панеле на флажёк, правой кнопкой мыши, навести на дополнительно и выбрать пункт "КОНСОЛЬ", как показано на рисунке.
                        </p>
                    </div>
                </div>
            </div>
