        ...
        <div class="">
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        ...
                        <p>
                            Перед началом работы, необходимо распоковать архив, с материалами задания, запустить виртуальный хостинг OpenServer.
                        <p>
            ...
            <div class="row mt-5">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        <p style=" margin-top: 50px;">
                            Перед началом работы, с помощью приложения phpMyAdmin, создать базу данных с именем "api_v2", для открытия прилодения phpMyAdmin необходимо нажать на иконку зелёного флажка на панеле задач, в появившемся меню выбрать пункт "дополнительно->". При созданий базы данных выбрать кодировку "utf8mb4_unicode_ci", как показано на рисунке.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p style=" margin-top: 50px;">
                            После этих команд проект должен запуститься в браузере на хосте "http://127.0.0.1:8000", сайт должен выглядеть как показано на рисунке.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
