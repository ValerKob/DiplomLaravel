        ...
        <div class="">
            ...
            <div class="row mt-5">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        <p style="text-indent: 20px; margin-top: 50px;">
                            Следующим шагом, откройте проект через косноль, через терминал OpenServer, открываю папку в терминале, туда я поподаю по средством ввода комманд, "cd 'названи папки'", так же вы можете попаст туда, посредством нажатия на TAB, консольсама будет подсказывать, а октрыть косноль можно очень просто, нажать на нижней панеле на флажёк, правой кнопкой мыши, навести на дополнительно и выбрать пункт "КОНСОЛЬ", как показано на рисунке.
                        </p>
                    </div>
                </div>
            </div>
