        ...
        <div class="">
            ...
            <div class="row mt-5">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        <p style="text-indent: 20px; margin-top: 50px;">
                            Далее откройте терминал OpenServer, в терминале перейдите в папку проекта "api_v2-main", туда я поподаю по средством ввода комманд, "cd 'названи папки'", так же вы можете попасть туда, посредством нажатия на TAB, консоль сама будет подсказывать, а октрыть косноль можно очень просто, нажать на нижней панеле на флажёк, правой кнопкой мыши, навести на дополнительно и выбрать пункт "КОНСОЛЬ", как показано на рисунке.
                        </p>
                    </div>
                </div>
            </div>
