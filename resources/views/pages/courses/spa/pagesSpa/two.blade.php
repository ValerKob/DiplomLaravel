            ...
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        ...
                        <p>
                            Прежде чем приступать к работе, разберёмся что такое API, и как работать, а также разберёмся, где находится API в самом проекте, и как посмотреть все порты API через консоль.
                        <p>
                            Для начала, открыть проект в VSC, открыть папку "routes", а внутри открыть папку "api.php", в этом файле показаны все роуты, а так же какие контроллеры отвечают за действие конкретных портов, всё это можно увидеть на рисунке.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p style="text-indent: 20px; margin-top: 50px;">
                            Теперь осталось лишь посмотреть, как обращаться к этим портам, для этого, нужно запустит консоль из нижней панели через флажёк, а дальше открыть проект в консоли, для этого нужно с помощью команд "cd 'путь к папке' " попасть в папку, конечный результат показан на картинке.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="row mt-5">
                    ...
                    <div class="offset-lg-1 col-lg-5 mt-5">
                        <div class="mt-30">
                            ...
                            <p>
                                Теперь после того как ввели команду в консоль, должны показаться все роуты.
                            <p>
                                С помощью этих роутов, будем дальше взаимодействовать со всем сайтом, на этом заканчивается настройка всего API, здесь больше ничего не сделать, если возникли какие-нибудь проблемы или ошибки, попробуйте начать всё заново, но внимательно читая, всё API показано на рисунке.
                            </p>
                        </div>
                    </div>
                </div>
