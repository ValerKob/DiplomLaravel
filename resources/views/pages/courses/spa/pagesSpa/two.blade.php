    ...
    <div class="container">
        ...
        <div class="">
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        ...
                        <p>
                            Прежде чем приступить к работе, необходимо разобраться, как работает предоставленное API: какие роуты используются и как к ним обращаться. Это необходимо, чтобы организовать работу с данными в приложении: их удаление, добавление, изменение и просмотр.
                        <p>
            ...
            <p style="text-indent: 20px; margin-top: 40px; margin-bottom: 40px;">
                В терминале ввести следующую команду(команды можно скопировать, нажав на кнопку copy):
            </p>
                ...
                <div class="row mt-5">
                    ...
                    <div class="offset-lg-1 col-lg-5">
                        <div class="mt-30">
                            ...
                            <p>
                                Использую эти роуты, будем осуществляться взаимодействие с сайтом. На этом настройка API закончена.
                            </p>
                        </div>
                    </div>
                </div>
