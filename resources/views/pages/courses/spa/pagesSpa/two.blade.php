            ...
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        ...
                        <p>
                            Прежде чем приступить к работе, необходимо разобраться, как работает предоставленное API: какие роуты используются и как к ним обращаться. Это необходимо, чтобы организовать работу с данными в приложении: их удаление, добавление, изминение и просмотр.
                        <p>
