...
<section class="portfolio_details_area section_gap">
    <div class="container">
        <div class="text-center" style="margin: -50px 0 50px 0;">
            <h2 class="text-left" style="color: #000;">5 Урок <br>Разбор задания, фунцкионал официанта</h2>
        </div>
        <div class="">
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row mt-5">
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p>
                            Для того чтобы сделать задание, создать файл AdminShift.jsx, скопируем в файл всё содержимое из папка WSR-Master "admin-shift.html", как должно выглядеть показано на рисунке.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
