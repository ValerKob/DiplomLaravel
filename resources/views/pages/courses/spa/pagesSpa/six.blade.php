            ...
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="mt-30">
                        ...
                        <p>
                            Для тестирования приложения будем использовать метод "Черного ящика". Протестировать приложение с точки зрения пользователя Протестировать надо не API, которое тебе предоставлено, вернее не только его, а SPA, которое ты разработал, именно то, что переход по сайту происходит без перезагрузки страниц.
                        </p>
                    </div>
                </div>
            </div>
