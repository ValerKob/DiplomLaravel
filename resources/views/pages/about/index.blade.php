...
$defaultBorderRadius: 7px;
          ...
          <p style="text-indent: 20px;">
            ...
            <h3 class="text-uppercase" style="margin: 40px 0 20px 20px;">Почему именно SASS?</h3>
<p style="text-indent: 20px;">
               В данном пособий, разработаем простую, но относительно полноценную дизайн-систему для веб-приложения средствами Sass.
            </p>
            <p style="text-indent: 20px;">
